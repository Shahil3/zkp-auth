...
public class KeyManager {
    ...
    public void storeKeyPair(String username , String password) throws Exception {
        ...
        // 3. Define paths
        Path directory = Paths.get(System.getProperty("user.home"), ".authlite", username);
        ...
        logger.info("Keys saved successfully in ~/.authlite/{}/", username);
    }
    ...
    public KeyPair loadKeyPair(String username, String password) throws Exception {
        ...
        if (!Files.exists(privateKeyPath) || !Files.exists(publicKeyPath) || !Files.exists(metadataPath)) {
            ...
            throw new IOException("Missing key files in ~/.authlite/. Cannot load keys.");
        }
        ...
        try {
            ...
            logger.info("Successfully loaded KeyPair from ~/.authlite/");
            return this.keyPair;
